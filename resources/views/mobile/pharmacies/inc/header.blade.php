<div class="header theme-bg py-2">
    <div class="container-fluid d-flex justify-content-between">
        <div class="head-left d-flex align-items-center justify-content-center">
            ...
            <span class="text-white ff-19">Pharmacy</span>
        </div>
        <div class="head-right">
            <img src="{{ asset('asset/images/Group 185.svg') }}" class="mr-3 w-20px" onclick="window.location='{{route('mobile.pharma.search')}}'">
            <img src="{{ asset('asset/images/Group 186.svg') }}" class="mr-3 w-20px" onclick="window.location='{{route('mobile.pharma.cart')}}'">
