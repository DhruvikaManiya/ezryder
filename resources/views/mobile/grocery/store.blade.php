                ...
                @foreach ($Product as $pro)
                    <div class="col-6 mb-4">
                        <div class="card product-card position-relative">
                            ...
                            <img src="{{ $pro->p_image }}" class="card-img-top" alt="..." onclick="window.location='{{ route('mobile.productdetails', $pro->id) }}'">
                            <div class="card-body">
                                <h5 class="card-title" onclick="window.location='{{ route('mobile.productdetails', $pro->id) }}'">{{ $pro->name }}</h5>
                                <h6 onclick="window.location='{{ route('mobile.productdetails', $pro->id) }}'">{{ $pro->user->name }}</h6>
