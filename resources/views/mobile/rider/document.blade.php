      ...
      <form method="post" action="{{ route('mobile.rider.add_document') }}" enctype="multipart/form-data">
        ...
        <div class="docu_box">
            <div class="docu_boxone">
                <div class="images">
                    <img src="{{ $document->id_proof_front==""? asset('asset/images/Group 5.svg'):asset('storage/id-proof/' . $document->id_proof_front) }}" class="img-fluid select-image image1"
                        data-image="image1">
            ...
            <div class="docu_boxone">
                <div class="images">
                    <img src="{{ $document->id_proof_back==""? asset('asset/images/Group 5.svg'):asset('storage/id-proof/' . $document->id_proof_back) }}" class="img-fluid select-image image2"
                        data-image="image2">
        ...
        <div class="docu_box">
            <div class="docu_boxone">
                <div class="images">
                    <img src="{{ $document->licence_front==""? asset('asset/images/Group 5.svg'):asset('storage/licence/'. $document->licence_front) }}" class="img-fluid select-image image1"
                        data-image="image1">
            ...
            <div class="docu_boxone">
                <div class="images">
                    <img src="{{ $document->licence_back==""? asset('asset/images/Group 5.svg'):asset('storage/licence/' . $document->licence_back) }}" class="img-fluid select-image image2"
                        data-image="image2">
        ...
        <div class="docu_box">
            <div class="docu_boxone">
                <div class="images">
                    <img src="{{ $document->vehicle_front==""? asset('asset/images/Group 5.svg'):asset('storage/vehicle/' . $document->vehicle_front) }}" class="img-fluid select-image image1"
                        data-image="image1">
            ...
            <div class="docu_boxone">
                <div class="images">
                    <img src="{{ $document->vehicle_back==""? asset('asset/images/Group 5.svg'):asset('storage/vehicle/' .$document->vehicle_back) }}" class="img-fluid select-image image2"
                        data-image="image2">
