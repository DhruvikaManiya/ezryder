...
@include('mobile.rider.inc.back-header')
    ...
    <section class="address_content space-both mt-30">
                        ...
                        <div class="frt-price-box-2 justi-s-b top-space30 p-both-25">
                            <div class="frt-b-data ml-11-m ">
                                ...
                                <a href="{{ route('mobile.rider.accept') }}">
                                    <p class="  order-heading font-weight-bold name-tag1"> <i
                                            class="bi bi-person icon-3"></i> John Due</p>

                            </div>
                            <p class="pt-2 fw-600 mbb-4">Pickup Address :</p>
                            <p class="location  ml-0 ml-16 icon-i space-index"><img
                                    src="http://127.0.0.1:8000/asset/images/clarity_map-marker-line.svg"
                                    class=" mr-1">D293, Laxmikrup,
                                D293, Laxmikdrupa, Arbadnagar, Odahv, Ahmedabad
                            </p>
                            <p class="pt-2 fw-600 mbb-4">Drop Address :</p>
                            <p class="location  ml-0 icon-i-2 ml-16 space-index"><img
                                    src="http://127.0.0.1:8000/asset/images/clarity_map-marker-line.svg"
                                    class=" mr-1">D293, Laxmikrup,
                            ...
                            <div class="d-flex justi-s-b pt-2">
                                ...
                                <a class="home-bttn" href="{{ route('mobile.rider.book-now') }}"><button>Accept</button></a>
                            </div>
                        </div>
                    </table>
                </div>
            ...
            <div class="col-12 pad-00 pb-3 ">
                <table>
                    <div class="frt-price-box-2 justi-s-b top-space30 p-both-25">
                        ...
                        <p class="pt-2 fw-600 mbb-4">Pickup Address :</p>
                        <p class="location  ml-0 ml-16 icon-i space-index"><img
                                src="http://127.0.0.1:8000/asset/images/clarity_map-marker-line.svg" class=" mr-1">D293,
                            Laxmikrup,
                            D293, Laxmikdrupa, Arbadnagar, Odahv, Ahmedabad
                        </p>
                        <p class="pt-2 fw-600 mbb-4">Drop Address :</p>
        ...
        <div class="col-12 pad-00 pb-3 ">
            <table>
                <div class="frt-price-box-2 frt-price-box-3 justi-s-b top-space30 p-both-25">
                    <div class="frt-b-data ml-11-m ">
                        <p class="order-heading space-id"><b>ID :</b> 1234 </p>
                        <a href="{{ route('mobile.rider.accept') }}">
                            <p class="  order-heading font-weight-bold name-tag1"> <i class="bi bi-person icon-3"></i> John
                                Due</p>
                    </div>
                    <p class="pt-2 fw-600 mbb-4">Pickup Address :</p>
                    <p class="location  ml-0 ml-16 icon-i space-index"><img
