...
@section('content')
    ...
    <div class="main-container no-padding navStyle storesFilters groceryStorePage" id="addBankDetails">
        <img src="{{ asset($store->logo) }}" alt="" class="bgImage">
        <article id="top-nav">
            <div class="reviewBackButton">
                <img src="/pages/assets/loginScreen/leftArrow.png" alt="" />
                <p>{{ $store->name }}</p>
            </div>
            <a href="{{ route('ecommerce.cart.view') }}">
                <span id="cartcount">{{ cartCount() }}</span>
                <img src="{{ asset('/asset/images/homeScreen/shoppingBag.png') }}" alt="" />
            </a>
        </article>
        <article class="about">
            <p><img src="/pages/assets/common/tickmark.png" alt="">
                @foreach ($store->time as $time)
                    {{ $time->day }} {{ $time->start_time }} to {{ $time->closing_time }},<br>
                @endforeach
            </p>
            <p><img src="/pages/assets/common/search.png" alt=""> {{ $store->address }}</p>

            <img src="/pages/assets/common/star.png" alt=""><img src="/pages/assets/common/star.png"
                alt=""><img src="/pages/assets/common/star.png" alt=""></p>
        </article>
        <article class="categories">
            @foreach ($categories as $categorie)
                <div class="category">
                    <img src="{{ asset($categorie->image) }}" alt="" />
                    <article class="desc">
