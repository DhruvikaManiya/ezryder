            ...
            <div class="col-100">
                ...
                <table class="h-table w100 tab-height mt88 tab-head1">
                    ...
                    <tbody class="text-center">
                           ...
                           <tr onclick="window.location='{{ route('vendor.order-detail-p', $order->id) }}'">
                               ...
                               <td class="status">
                                  {{ $order->status == 0 ? 'Pending' : ($order->status == 1 ? 'Processing' : ($order->status == 2 ? 'Delivered' : ($order->status == 4 ? 'Pickup' :($order->status== 3 ? 'Rejected':($order->status == 5 ? 'PickupDone':'Canceled')) ))) }}
