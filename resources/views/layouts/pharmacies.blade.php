...
<head>
    ...
    <link rel="stylesheet" href="{{asset('asset/css/pharmacies.css')}}">
...
<body class="home">
    @include('mobile.pharmacies.inc.sidemanu')

    @yield('content')

    @include('mobile.pharmacies.inc.footer')
     ...
     <script>
           ...
           <script>
            ...
            $('body').on('click', '#wishlist', function() {
                ...
                $.ajax({
                    url: "{{ route('pharma.wishlist.store') }}",
                    method: "POST",
                    data: {
                        id: id,
                        user_id: user_id,
