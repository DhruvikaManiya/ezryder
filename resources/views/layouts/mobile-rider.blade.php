...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('asset/css/mobile-rider.css') }}">
    <link rel="stylesheet" href="{{ asset('asset/css/rental-home.css') }}">
    <link rel="stylesheet" href="{{ asset('asset/css/riderdriver.css') }}">
...
<body class="home">
    ...
    @include('mobile.rider.inc.footer')
